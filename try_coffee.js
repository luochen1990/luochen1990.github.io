...
(function() {
  var decode, encode, filter_empty_item, init_coffee_editor, init_status, is_empty_item, set_code, set_libs, set_status, status, storage;
  ...
  init_status = function() {
    var code, libs, ref, ref1, ref2;
    ref = decode(location.search), libs = ref.libs, code = ref.code;
    status = {
      libs: libs != null ? libs : [],
      code: (ref1 = (ref2 = obj(location.hash.slice(1) || 'null')) != null ? ref2 : code) != null ? ref1 : "log -> 'hello, coffee-mate!'"
    };
    if (status.code != null) {
      location.hash = json(status.code);
      return location.search = status.libs.length > 0 ? encode({
        libs: status.libs
      }) : '';
    }
  };
  ...
  set_code = function(code) {
    status.code = code != null ? code : '';
    return location.hash = json(status.code);
  };

  $(document).ready(function() {
    var editor, j, len, ref, url;
