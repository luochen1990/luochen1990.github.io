...
其实，构造这个judge_list函数，是基于一种叫做**Pointless**的想法。Pointless就是说，你定义的东西（如函数），应该可以独立的存在，并且具有完整的语义，而与应用到的具体目标无关。在以上的演示中，我们已经看到，Pointless的想法，是避免重复的有效手段。

当然了，只要做到了Pointless，不管用不用“科里化”这种方式，我们都可以有效地避免重复，科里化的意义，仅仅是某些时候可以让事情方便那么一点点。
