...
(function() {
  var animate, array_b_search, assert, b_search, best, canvas, cartesian_product, err, height, i, id, img, log, pen, polyline, position, random_gen, ranged_random_gen, square, sum, switch_anim, vec, weight, width, _ref,
    __slice = [].slice;
