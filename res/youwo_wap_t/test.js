...
(function() {
  var animate, best, canvas, cartesian_product, err, height, i, id, img, log, pen, pos_size0, pos_size1, random_gen, ranged_random_gen, square, sum, switch_anim, vec, width, _ref,
    __slice = [].slice;
  ...
  animate = function(st0, st1, mix, draw_one_frame, clear, duration, fps) {
    var anim, frame_interval, frame_num;
    if (fps == null) {
      fps = 50;
    }
    ...
    anim = function(frame_id) {
      var st;
      st = mix(st0, st1, frame_id / frame_num);
      clear();
      draw_one_frame(st);
